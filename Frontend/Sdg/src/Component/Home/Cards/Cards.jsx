            ...
            >
              ...
              <div className="absolute w-full h-full backface-hidden rounded-xl overflow-hidden shadow-md border bg-white">
                <div
                  ...
                  style={{ backgroundImage: `url(${category.banner})` }}
                >
                  <div className="absolute top-0 w-full bg-black/50 text-white text-lg font-bold text-center py-2">
                    {category.name}
                  </div>
                </div>
              </div>
              ...
              <div className="absolute w-full h-full backface-hidden rotate-y-180 bg-white rounded-xl p-2 grid grid-cols-2 gap-2 shadow-md border overflow-hidden">
                {category.goals.map((img, i) => (
                  ...
                  >
                    ...
                    {img === G4 && <img src={G4} alt="Goal 4" className="h-22 w-59" />}
                    {img === G5 && <img src={G5} alt="Goal 5" className="h-22 w-59" />}
                    {img === G6 && <img src={G6} alt="Goal 6" className="h-23 w-59" />}
                    {img === G7 && <img src={G7} alt="Goal 7" className="h-23 w-59" />}
                    {img === G8 && <img src={G8} alt="Goal 8" className="h-35 w-59" />}
                    {img === G9 && <img src={G9} alt="Goal 9" className="h-35 w-59" />}
                    {img === G10 && <img src={G10} alt="Goal 10" className="h-22 w-59" />}
                    {img === G11 && <img src={G11} alt="Goal 11" className="h-35 w-59" />}
                    {img === G12 && <img src={G12} alt="Goal 12" className="h-71 w-60" />}
                    {img === G13 && <img src={G13} alt="Goal 13" className="h-22 w-59" />}
                    {img === G14 && <img src={G14} alt="Goal 14" className="h-22 w-59" />}
                    {img === G15 && <img src={G15} alt="Goal 15" className="h-22 w-59" />}
                    {img === G16 && <img src={G16} alt="Goal 16" className="h-71 w-60" />}
                    {img === G17 && <img src={G17} alt="Goal 17" className="h-71 w-60" />}
                  </div>
                ))}
              </div>
            </div>
